...
Inherits Listbox
	...
	#tag Event
		Sub Open()
		  me.alternateRows = true
		  #if TargetMacOS then
		    me.alternateColor = &cF5F5F500
		  #else
		    me.alternateColor = &cEDF4FF
		  #endif
		  OPen //Call the event for subs
		End Sub
	#tag EndEvent


	#tag Method, Flags = &h0
		Sub SetAlternatingRows(assigns b as boolean)
		  alternateRows = b
		End Sub
	#tag EndMethod
	...
	#tag Property, Flags = &h1
		Protected alternateColor As color
	#tag EndProperty

	#tag Property, Flags = &h1
		Protected alternateRows As boolean
	#tag EndProperty
