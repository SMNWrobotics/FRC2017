#tag Window
Begin ContainerControl ccImage Implements itrRowDesign
   AcceptFocus     =   False
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   &cFFFFFF00
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Save()
		  ...
		  dim sEncode as string = EncodeBase64(s)
		  oValue.sValue = sEncode
		  oValue.save
...
#tag Events btnGetImage
	#tag Event
		Sub Action()
		  dim f as FolderItem
		  
		  f = GetOpenFolderItem(FileTypeImages.All)
