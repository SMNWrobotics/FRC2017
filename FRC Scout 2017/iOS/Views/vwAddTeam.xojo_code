...
Begin iosView vwAddTeam
   ...
   Begin iOSLabel Label1
      ...
      AutoLayout      =   Label1, 3, TopLayoutGuide, 4, False, +1.00, 1, 1, 0, 
   ...
   Begin iOSTextField txtKey
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   txtKey, 1, Label1, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtKey, 2, Label1, 2, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtKey, 3, Label1, 4, False, +1.00, 1, 1, *kStdControlGapV, 
      AutoLayout      =   txtKey, 8, , 0, True, +1.00, 1, 1, 31, 
      Enabled         =   True
      Height          =   31.0
      KeyboardType    =   "0"
      Left            =   20
   ...
   Begin iOSLabel Label2
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   Label2, 1, txtKey, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   Label2, 7, , 0, False, +1.00, 1, 1, 280, 
      AutoLayout      =   Label2, 3, txtKey, 4, False, +1.00, 1, 1, *kStdControlGapV, 
   ...
   Begin iOSTextField txtTeamNumber
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   txtTeamNumber, 1, Label2, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtTeamNumber, 7, , 0, False, +1.00, 1, 1, 280, 
      AutoLayout      =   txtTeamNumber, 3, Label2, 4, False, +1.00, 1, 1, *kStdControlGapV, 
   ...
   Begin iOSLabel Label3
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   Label3, 1, txtTeamNumber, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   Label3, 7, , 0, False, +1.00, 1, 1, 280, 
      AutoLayout      =   Label3, 3, txtTeamNumber, 4, False, +1.00, 1, 1, *kStdControlGapV, 
   ...
   Begin iOSTextField txtName
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   txtName, 1, Label3, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtName, 7, , 0, False, +1.00, 1, 1, 280, 
      AutoLayout      =   txtName, 3, Label3, 4, False, +1.00, 1, 1, *kStdControlGapV, 
   ...
   Begin iOSButton btnSave
      ...
      AutoLayout      =   btnSave, 2, <Parent>, 2, False, +1.00, 1, 1, -*kStdGapCtlToViewH, 
      AutoLayout      =   btnSave, 3, txtName, 4, False, +1.00, 1, 1, *kStdControlGapV, 
