...
Begin iosView vwTeleopGears
   ...
   Begin iOSLabel Label1
      ...
      AutoLayout      =   Label1, 7, , 0, False, +1.00, 1, 1, 76, 
   ...
   Begin iOSLabel Label2
      ...
      AutoLayout      =   Label2, 7, , 0, False, +1.00, 1, 1, 76, 
   ...
   Begin iOSLabel Label3
      ...
      AutoLayout      =   Label3, 7, , 0, False, +1.00, 1, 1, 111, 
      AutoLayout      =   Label3, 3, <Parent>, 3, False, +1.00, 1, 1, 173, 
   ...
   Begin iOSTextField txtAcquired
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   txtAcquired, 1, Label2, 2, False, +1.00, 1, 1, *kStdControlGapH, 
      AutoLayout      =   txtAcquired, 7, , 0, False, +1.00, 1, 1, 52, 
      AutoLayout      =   txtAcquired, 8, , 0, True, +1.00, 1, 1, 31, 
      AutoLayout      =   txtAcquired, 11, Label1, 11, False, +1.00, 1, 1, 0, 
      Enabled         =   True
      Height          =   31.0
      KeyboardType    =   "4"
      Left            =   104
   ...
   Begin iOSTextField txtMade
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   txtMade, 1, txtAcquired, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtMade, 7, , 0, False, +1.00, 1, 1, 52, 
      AutoLayout      =   txtMade, 11, Label2, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   txtMade, 8, , 0, True, +1.00, 1, 1, 31, 
      Enabled         =   True
      Height          =   31.0
      KeyboardType    =   "4"
      Left            =   104
   ...
   Begin Extensions.UIStepper StepperAcquired
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   StepperAcquired, 4, txtMade, 3, False, +1.00, 1, 1, -*kStdControlGapV, 
      AutoLayout      =   StepperAcquired, 1, txtAcquired, 2, False, +1.00, 1, 1, *kStdControlGapH, 
      AutoLayout      =   StepperAcquired, 2, txtMade, 1, False, +1.00, 1, 1, 144, 
      AutoLayout      =   StepperAcquired, 3, Label1, 3, False, +1.00, 1, 1, 0, 
      autorepeat      =   False
      continuous      =   False
      Height          =   29.5
      Left            =   164
   ...
   Begin Extensions.UIStepper StepperMade
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   StepperMade, 1, StepperAcquired, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   StepperMade, 7, , 0, False, +1.00, 1, 1, 84, 
      AutoLayout      =   StepperMade, 3, txtAcquired, 4, False, +1.00, 1, 1, *kStdControlGapV, 
      AutoLayout      =   StepperMade, 8, , 0, False, +1.00, 1, 1, 29, 
      autorepeat      =   False
      continuous      =   False
      Height          =   29.0
      Left            =   164
   ...
   Begin iOSLabel Label4
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   Label4, 9, <Parent>, 9, False, +1.00, 1, 1, 0, 
      AutoLayout      =   Label4, 7, , 0, False, +1.00, 1, 1, 76, 
      AutoLayout      =   Label4, 3, Label3, 4, False, +1.00, 1, 1, *kStdControlGapV, 
   ...
   Begin iOSLabel Label5
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   Label5, 1, Label4, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   Label5, 7, , 0, False, +1.00, 1, 1, 76, 
      AutoLayout      =   Label5, 3, <Parent>, 3, False, +1.00, 1, 1, 240, 
   ...
   Begin iOSLabel Label6
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   Label6, 1, Label5, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   Label6, 7, , 0, False, +1.00, 1, 1, 76, 
      AutoLayout      =   Label6, 3, <Parent>, 3, False, +1.00, 1, 1, 269, 
   ...
   Begin iOSLabel Label7
      ...
      AutoLayout      =   Label7, 7, , 0, False, +1.00, 1, 1, 76, 
      AutoLayout      =   Label7, 3, <Parent>, 3, False, +1.00, 1, 1, 297, 
   ...
   Begin iOSLabel lblCurrentTime
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   lblCurrentTime, 1, lblTotalTime, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblCurrentTime, 7, , 0, False, +1.00, 1, 1, 32, 
      AutoLayout      =   lblCurrentTime, 11, Label7, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblCurrentTime, 8, , 0, False, +1.00, 1, 1, 30, 
      Enabled         =   True
      Height          =   30.0
      Left            =   218
      LineBreakMode   =   "0"
   ...
   Begin iOSLabel lblAvgTime
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   lblAvgTime, 1, lblTotalTime, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblAvgTime, 7, , 0, False, +1.00, 1, 1, 32, 
      AutoLayout      =   lblAvgTime, 11, Label6, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblAvgTime, 8, , 0, False, +1.00, 1, 1, 30, 
      Enabled         =   True
      Height          =   30.0
      Left            =   218
      LineBreakMode   =   "0"
   ...
   Begin iOSLabel lblAttempts
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   lblAttempts, 11, Label4, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblAttempts, 8, , 0, False, +1.00, 1, 1, 30, 
      AutoLayout      =   lblAttempts, 1, Label4, 2, False, +1.00, 1, 1, 20, 
      AutoLayout      =   lblAttempts, 7, , 0, False, +1.00, 1, 1, 32, 
      Enabled         =   True
      Height          =   30.0
      Left            =   218
      LineBreakMode   =   "0"
   ...
   Begin iOSLabel lblTotalTime
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   lblTotalTime, 11, Label5, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblTotalTime, 8, , 0, False, +1.00, 1, 1, 30, 
      AutoLayout      =   lblTotalTime, 1, lblAttempts, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   lblTotalTime, 7, , 0, False, +1.00, 1, 1, 32, 
      Enabled         =   True
      Height          =   30.0
      Left            =   218
      LineBreakMode   =   "0"
   ...
   Begin iOSButton btnStartStop
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AutoLayout      =   btnStartStop, 1, Label3, 1, False, +1.00, 1, 1, 0, 
      AutoLayout      =   btnStartStop, 7, , 0, False, +1.00, 1, 1, 100, 
      AutoLayout      =   btnStartStop, 11, Label5, 11, False, +1.00, 1, 1, 0, 
      AutoLayout      =   btnStartStop, 8, , 0, False, +1.00, 1, 1, 30, 
      Caption         =   "Start"
      Enabled         =   True
      Height          =   30.0
      Left            =   20
