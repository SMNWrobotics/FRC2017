...
//        SmartDashboard.putData("_LiftUp", new _LiftUp());
//        SmartDashboard.putData("_LiftDown", new _LiftDown());
//        SmartDashboard.putData("AutoDoNothing", new AutoDoNothing());
//        SmartDashboard.putData("AutoLeft", new AutoLeft());
//        SmartDashboard.putData("AutoMid", new AutoMid());
//        SmartDashboard.putData("AutoRight", new AutoRight());
//        SmartDashboard.putData("AutoBaseLine", new AutoBaseLine());
////        SmartDashboard.putData("_Move", new _Move());
////        SmartDashboard.putData("_Rotate", new _Rotate());
//        SmartDashboard.putData("_CameraOff", new _CameraOff());
