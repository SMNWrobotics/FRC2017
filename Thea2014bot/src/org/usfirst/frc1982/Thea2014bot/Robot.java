...
import org.frc1982.common.AllianceChoice;
...
//    GripPipelineTooMuch gripPipeline;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        SmartDashboard.putData( AllianceChoice.TITLE, teamChoice );         
        SmartDashboard.putData( FieldPosition.TITLE, fieldPosition );
...
//        gyro.calibrate();
    ...
    public void autonomousInit() {
    	...
    	AllianceChoice tc = teamChoice.getSelected();
    	FieldPosition fp = fieldPosition.getSelected();
    	Goal g = goal.getSelected();
    	
    	autonomousCommand = getAutonomousProgram(tc,fp,g);
    	System.out.println( AllianceChoice.TITLE + " = " + tc );
    	System.out.println( FieldPosition.TITLE + " = " + fp );
    	System.out.println( Goal.TITLE + " = " + g );
    ...
    private Command getAutonomousProgram(AllianceChoice tc, FieldPosition fp, Goal g) {
