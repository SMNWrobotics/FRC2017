...
//        driveEncoderFrontRight.setDistancePerPulse(1.0);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveEncoderFrontRight.setDistancePerPulse(0.08294634068); //inches per count
        driveEncoderFrontLeft.setDistancePerPulse(0.0759297318); //inches per count
...
//        shootershooterMotor = new CANTalon(5);
        ...
        intakeRollerMot = new CANTalon(5);
        
        intakeLimitBot = new DigitalInput(9);
        intakeLimitTop = new DigitalInput(8);
