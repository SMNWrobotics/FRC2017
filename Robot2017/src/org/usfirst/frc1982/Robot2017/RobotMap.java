...
public class RobotMap {
    ...
    public static Servo shooterServoSystemIntakeServo;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static Servo armHolder;
    ...
    public static void init() {
        ...
        shooterServoSystemIntakeServo = new Servo(4);
        LiveWindow.addActuator("ShooterServoSystem", "IntakeServo", shooterServoSystemIntakeServo);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        armHolder = new Servo(5);
//        frontLeftPID = new PIDController( 0.0, 0.0, 0.0, driveEncoderFrontLeft, driveFrontLeft, 20);
//        frontRightPID = new PIDController( 0.0, 0.0, 0.0, driveEncoderFrontRight, driveFrontRight, 20);
//        backLeftPID = new PIDController( 0.0, 0.0, 0.0, 0.0, driveEncoderBackLeft, driveBackLeft, 20);
//        backRightPID = new PIDController( 0.0, 0.0, 0.0, 0.0, driveEncoderBackRight, driveBackRight, 20);
    }
}
